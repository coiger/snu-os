...
static __read_mostly const s64 sin_deg[360] = {
    0x0LL,
    0x477c2cae2774LL,
    0x8ef2c64fbee1LL,
    0xd65e3a477e48LL,
...
static inline fixed64_t xmul(fixed64_t x, fixed64_t y) {
	...
	return sign * (x >= y ? __xmul((u64)x, (u64)y) : __xmul((u64)y, (u64)x));
}
...
static inline fixed64_t __xsin(fixed64_t r,
			      fixed64_t r2d2,
			      fixed64_t r3d6,
			      fixed64_t sin_0,
			      fixed64_t cos_0) {
...
static inline fixed64_t __xcos(fixed64_t r,
			      fixed64_t r2d2,
			      fixed64_t r3d6,
			      fixed64_t sin_0,
			      fixed64_t cos_0) {
...
static inline fixed64_t to_fixed(s32 integer, s32 fractional) {
	return (fixed64_t)integer * FIXED_PRECISION + div_s64(((fixed64_t)(fractional)) * FIXED_PRECISION_D10000, 100);
}
...
typedef fixed64_t (*__fixed_impl_t)(fixed64_t, fixed64_t, fixed64_t, fixed64_t, fixed64_t);

static inline fixed64_t __fixed_call_impl(int x0, fixed64_t d, __fixed_impl_t impl) {
...
fixed64_t calc_hav(const int x_lat_int,
                   const int x_lat_frac,
                   const int x_lng_int,
                   const int x_lng_frac,
                   const int y_lat_int,
                   const int y_lat_frac,
                   const int y_lng_int,
                   const int y_lng_frac);

int is_geo_close(const int x_lat_int,
                 const int x_lat_frac,
                 const int x_lng_int,
                 const int x_lng_frac,
                 const int y_lat_int,
